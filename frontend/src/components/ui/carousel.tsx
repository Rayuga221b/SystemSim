// Adapted from shadcn/ui carousel. Removed 'use client' (Vite/React, not Next.js).
// Powered by embla-carousel-react.
...
function Carousel({
  ...
  return (
    <CarouselContext.Provider value={{
      carouselRef, api, opts, orientation: orientation || (opts?.axis === "y" ? "vertical" : "horizontal"),
